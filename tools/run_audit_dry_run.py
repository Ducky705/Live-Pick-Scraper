...
async def main():
    ...
    if not all_msgs:
        ...
        if os.path.exists(cached_file):
            ...
            if files:
                ...
                golden_path = os.path.join(os.path.dirname(__file__), "../new_golden_set.json")
    ...
    if ocr_tasks:
        ...
        for t_idx, text_result in enumerate(results):
            ...
            if text_result and not text_result.startswith("[Error"):
                ...
                unique_msgs[original_idx]["ocr_text"] = "\n".join(unique_msgs[original_idx]["ocr_texts"])
    ...
    if not selected_msgs:
        ...
        logger.info(f"Forcing selection of first {len(selected_msgs)} messages for audit.")
