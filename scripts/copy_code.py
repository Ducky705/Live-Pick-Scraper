...
EXCLUDE_DIRS = {
    ...
    'temp_images', '.idea', '.vscode', 'eggs', '*.egg-info',
...
def main():
    ...
    output.append(f"Type: Python + JavaScript Web Application")
    output.append(f"Stack: Flask (Python backend), Vanilla JS frontend, Tailwind CSS")
    output.append("")
