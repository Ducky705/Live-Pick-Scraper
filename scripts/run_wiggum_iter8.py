...
logger = logging.getLogger("WiggumIter8")

GOLDEN_SET_PATH = os.path.join(os.path.dirname(__file__), "../new_golden_set.json")
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "../data/output/test_wiggum_iter8.json")
...
async def run_wiggum():
    ...
    # Implicitly uses batch_size=1 from ExtractionPipeline default
