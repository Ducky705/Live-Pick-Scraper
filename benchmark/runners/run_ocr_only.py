...
from src.ocr_handler import extract_text_ai, extract_text_batch, extract_text_simple_tesseract, extract_text_v3
...
def run_ocr_benchmark(engine="tesseract_v3"):
    ...
    with open(out_file, "w", encoding="utf-8") as f:
        json.dump(
            {"engine": engine, "metrics": {"avg_cer": avg_cer, "avg_wer": avg_wer}, "details": results}, f, indent=2
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--engine",
        type=str,
        default="tesseract_v3",
        choices=["tesseract_simple", "tesseract_v3", "ai_vision", "pipeline_d"],
    )
