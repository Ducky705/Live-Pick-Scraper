...
logger = logging.getLogger("Benchmark18")
...
def run_benchmark():
    logger.info("Starting Ralph Wiggum Loop - Iteration 18 (Sequential Fast-Fail)...")
    ...
    logger.info("=" * 40)
    logger.info("BENCHMARK RESULTS (ITERATION 18)")
    logger.info("=" * 40)
    ...
    # Save Stats
    with open("iteration_18_stats.txt", "w") as f:
